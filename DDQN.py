...
class DDDQN(tf.keras.Model):
    def __init__(self, num_actions):
        ...
        self.front_end_layer_list = [
            tf.keras.layers.Conv2D(6, kernel_size=(3, 3), strides=2, padding='valid', activation='relu'),
            tf.keras.layers.Conv2D(8, kernel_size=(3, 3), strides=2, padding='valid', activation='relu'),
            tf.keras.layers.Conv2D(10, kernel_size=(3, 3), strides=2, padding='valid', activation='relu'),
